export default {
    ...
    canvas: {
        ...
        editors: {
            ...
            maskTitle: "Local mask edit", maskHint: "Paint, draw a rectangle, or lasso the area to edit · Mouse wheel to zoom · Ctrl/Cmd+Z to undo", brush: "Brush", rectangle: "Rectangle", lasso: "Lasso", selectArea: "Select area", erase: "Erase", undoMaskTitle: "Undo selection (Ctrl/Cmd+Z)", undoMask: "Undo selection", redoMaskTitle: "Redo selection (Ctrl/Cmd+Shift+Z)", redoMask: "Redo selection", brushSize: "Brush size", editInstructions: "Edit instructions", maskPlaceholder: "For example: change the framed product to red and keep everything else unchanged", maskPromptRequired: "Enter edit instructions", maskRequired: "Select the area to edit first", aiEdit: "Edit with AI",
        ...
        promptPanel: { video: "Describe the video you want to generate", audio: "Describe the audio you want to generate", image: "Describe the image you want to generate", text: "Describe the text you want to generate", editImage: "Describe how you want to change this image", editText: "Describe how you want to revise this text", expandEditor: "Expand editor", editorTitle: "Edit prompt", stopGeneration: "Stop generation", generate: "Generate", stop: "Stop", addReference: "Add reference image", referenceImages: "Reference images", previewReference: "Preview {{label}}", removeReference: "Remove {{label}}", referencePreview: "Reference image preview", imageOnly: "Select image files", imageLimit: "You can add up to {{count}} reference images", imageTooLarge: "Each image must be under {{size}} MB", imageUploadFailed: "Failed to add the reference image" },
    ...
    config: {
        ...
        quickSetup: {
            ...
            apiKeyPlaceholder: "Enter your own Key",
            model: "Model",
        },
        localStorage: {
